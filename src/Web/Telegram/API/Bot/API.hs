...
leaveChat :: Token -> Maybe Text -> Manager -> BaseUrl -> IO (Either ServantError LeaveChatResponse)
leaveChat token chat_id manager = runExceptT $ leaveChat_ token (Just chat_i) manager telegramBaseUrl
...
getChat token chat_id manager = runExceptT $ getChat_ token (Just chat_i) manager telegramBaseUrl
...
getChatAdministrators token chat_id manager = runExceptT $ getChatAdministrators_ token (Just chat_i) manager telegramBaseUrl

-- | Use this method to get the number of members in a chat. Returns Int on success.
getChatMembersCount :: Token -> Text -> Manager -> IO (Either ServantError GetChatMembersCountResponse)
getChatMembersCount token chat_id manager = runExceptT $ getChatMembersCount_ token (Just chat_i) manager telegramBaseUrl

-- | Use this method to get information about a member of a chat. Returns a ChatMember object on success.
getChatMember :: Token -> Text -> Int -> Manager -> IO (Either ServantError GetChatMemberResponse)
getChatMember token chat_id user_id manager = runExceptT $ getChatMember_ token (Just chat_i) (Just user_id) manager telegramBaseUrl
